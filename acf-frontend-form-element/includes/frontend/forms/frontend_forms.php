...
if ( !class_exists( 'ACFFrontendForm' ) ) {
    class ACFFrontendForm
    {
        ...
        public function prepare_field( $field )
        {
            ...
            if ( isset( $field['start_column'] ) && $field['start_column'] ) {
        ...
        public function render_field_wrap(
            $field,
            $element = 'div',
            $instruction = 'label',
            $hooked = false
        ...
        public function render_form( $args = array() )
        {
                    ...
                    if ( is_array( $field_data ) ) {
                        ...
                        if ( isset( $field_data['acf'] ) ) {
                            ...
                            if ( $field_data['type'] == 'product_type' ) {
                                $args['product_types_field'] = true;
                            }
                            if ( $field_data['acf'] == 'acfef_' . $field_data['form'] . '_manage_stock' ) {
                                $args['product_manage_stock'] = true;
                            }
                        } else {
                            $fields[] = $field_data;
                        }
            ...
            $hidden_defaults = $this->hidden_default_fields( $args );
        ...
        public function hidden_default_fields( $form )
        {
            ...
            if ( !acfef_edit_mode() && $form['action'] == 'product' ) {
        ...
        public function __construct()
        {
            ...
            add_filter( 'acf/prepare_field', [ $this, 'prepare_field' ], 3 );
        }
...
add_action( 'wp_ajax_acfef/delete_object', 'acfef_delete_object' );
add_action( 'wp_ajax_nopriv_acfef/delete_object', 'acfef_delete_object' );
function acfef_delete_object()
{
    acfef()->frontend_form->delete_object();
}
