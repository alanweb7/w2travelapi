...
jQuery('body').on('click', '.sub-fields-open', function() {
    ...
    var modal = jQuery('<div id="modal_'+type+'" class="modal edit-modal show" data-clear="1"><div class="modal-content" style="width:100%;margin:25px auto;text-align:center"><div class="modal-inner"><div class="content-container"><button class="sub-fields-close" type="button" data-type="'+type+'"><span class="close-modal-text">Close</span></button></div></div></div></div>');
