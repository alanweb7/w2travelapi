 ...
 */
class Library_Functions_Mega_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/library-functions-mega-public.js', array( 'jquery' ), $this->version, false );
